...
// Si no hay regalos que falten o sobren, las propiedades correspondientes(missing o extra) 
// deben ser objetos vacíos.
...
function fixGiftList(received, expected) {
    ...
    //gifts.missing['ball'] = 1;

    const giftsReceived = received.sort();
    const giftsExpected = expected.sort();

    console.log(giftsReceived, gifts);
