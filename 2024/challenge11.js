...
// Tu tarea es implementar una función que reciba un string con el nombre de un archivo codificado y devuelva solo la parte importante: 
...
function decodeFilename(filename) {
    let splits = filename.split('.').splice(0, 2);
    splits[0] = splits[0].split('_').slice(1).join('_');
    return splits.join('.');
}